...
public class CardboardBox2 {
   private static int noOfBoxes = 0;
   private int width, height, depth;
   private String colour;

   public CardboardBox2() {
      noOfBoxes++;
   }//Default Constructor

   public CardboardBox2(int boxWidth, int boxHeight, int boxDepth) {
      width = boxWidth;
      height = boxHeight;
      depth = boxDepth;
      colour = "unknown";
   ...
   public CardboardBox2(int boxWidth, int boxHeight, int boxDepth, String boxColour) {
      width = boxWidth;
      height = boxHeight;
      depth = boxDepth;
      colour = boxColour;
